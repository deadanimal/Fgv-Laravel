  ...
  <div class="col-xl-12 text-center">
      ...
      Rumusan Kerosakan Mengikut Baka Tahun {{ $tahun }}
      </h4>
  </div>
          ...
          <table class="table table-hover table-bordered overflow-hidden" width="100%">
              <thead class="border border-dark" style="background-color: #d9d9d9;">
                  <tr>
                      ...
                      <th rowspan="3">Jumlah Rosak Faktor Biologi</th>
                      <th rowspan="3">Peratus Rosak Faktor Biologi</th>
                  </tr>
                  <tr>
