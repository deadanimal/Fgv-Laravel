  ...
  <div class="col-xl-12 text-center">
      ...
      REKOD HARIAN KEROSAKAN PETUGAS (QC)</h4>
  </div>
              ...
              <?php
                ...
                if ($result -> num_rows > 0)
                {
	                ...
	                {    
                        ...
                        $sql_data_jumlah = "SELECT COUNT(QC.id) As num 
                        FROM quality_controls QC
                        INNER JOIN pokoks P
                        ON QC.pokok_id = P.id
                        WHERE P.jantina = 'Motherpalm'
                        ...
                        $sql_data_jumlah_bawah_all = "SELECT COUNT(QC.id) As num 
                        FROM quality_controls QC
                        INNER JOIN pokoks P
                        ON QC.pokok_id = P.id
                        WHERE P.jantina = 'Motherpalm'
                        ...
                        for ($i = 1; $i <= 31; $i++)
                        {
                            ...
                            $sql_data = "SELECT COUNT(QC.id) As num 
                            FROM quality_controls QC
                            INNER JOIN pokoks P
                            ON QC.pokok_id = P.id
                            WHERE P.jantina = 'Motherpalm'
                            ...
                            $sql_data_jumlah_bawah = "SELECT COUNT(QC.id) As num 
                            FROM quality_controls QC
                            INNER JOIN pokoks P
                            ON QC.pokok_id = P.id
                            WHERE P.jantina = 'Motherpalm'
